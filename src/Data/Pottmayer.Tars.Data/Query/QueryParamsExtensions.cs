...
/// <summary>
/// Converts <see cref="QueryParams"/> to <see cref="DataQueryParams{TEntity}"/> with whitelist validation
/// and expression building. Provider-agnostic: it produces an <see cref="Expression{TDelegate}"/> predicate
/// that any LINQ provider (EF Core, MongoDB driver) can translate.
/// </summary>
