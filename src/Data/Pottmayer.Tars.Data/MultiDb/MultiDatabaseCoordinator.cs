...
namespace Pottmayer.Tars.Data.MultiDb;

/// <summary>
/// Best-effort sequential coordinator (Level 1). Provider-agnostic: the participating keys may resolve
/// to any mix of backends. Commits each database in order; on failure, invokes <paramref name="compensate"/>
/// when provided. Does NOT guarantee atomicity — use an outbox pattern for production-grade consistency.
/// </summary>
