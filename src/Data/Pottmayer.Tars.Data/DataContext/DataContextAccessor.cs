...
/// <summary>
/// Async-local storage for ambient data contexts. Provider-agnostic.
/// Non-keyed slot is used by <see cref="Pottmayer.Tars.Data.Repositories.RepositoryResolver"/> during DI
/// resolution; keyed slots track concurrent database contexts (one per database role).
/// </summary>
