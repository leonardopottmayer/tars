...
namespace Pottmayer.Tars.Data.UnitOfWork;

/// <summary>
/// Unit of work that lazily creates its <see cref="IDataContext"/> on first access.
/// Provider-agnostic — the context is produced by the <see cref="IDataContextFactory"/> for the key,
/// so the same unit of work drives a relational or a document backend without change.
/// </summary>
